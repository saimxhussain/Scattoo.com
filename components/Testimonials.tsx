    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 32px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start' }}>
          ...
          {/* RIGHT — Problem / Solution / Review stacked */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                <div style={{
                  width: 32, height: 32, borderRadius: 8, background: 'rgba(255,77,0,0.12)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}>
            ...
            {/* Review */}
            <div style={{
              background: '#fff9f6', borderRadius: '4px 4px 16px 16px',
              padding: '32px 32px', border: '1.5px solid rgba(255,77,0,0.12)', borderTop: 'none',
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                <div style={{
                  width: 32, height: 32, borderRadius: 8, background: 'rgba(255,77,0,0.08)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}>
