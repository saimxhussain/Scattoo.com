...
// SVG icons — clean line style, no emojis
const icons: Record<string, React.ReactNode> = {
  ...
  '02': <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1" fill="currentColor"/></svg>,
          ...
          {svcs.map((s, i) => (
            <Reveal key={i} delay={i * 40}>
              ...
              >
                ...
                <div style={{ fontFamily: 'EquitanSans, sans-serif', fontSize: 10, fontWeight: 700, letterSpacing: 2, color: '#ccc', marginBottom: 10 }}>{s.tag}</div>
